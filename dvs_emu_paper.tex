...
\missingfigure{RATE vs TIME vs TIME-EXP spike trains}
...
\missingfigure{Regular vs Inhibited spikes}

\missingfigure{History decay: Error in frame, recovery sequence}

\missingfigure{Adaptive threshold: low changing pixels and how they could spike}
